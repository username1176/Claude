  ...
  return (
    <Card glass className="animate-slide-up">
      <CardHeader className="text-center pb-4">
        ...
        <p className="text-sm text-slate-400 mt-1">Sign in to access your tax optimization plan</p>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="password" type={showPassword ? "text" : "password"} placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 pr-10" required autoComplete="current-password" />
          ...
          {error && (
            <div className="rounded-lg p-3 text-sm text-red-400" style={{ background: "rgba(127,29,29,0.3)", border: "1px solid rgba(239,68,68,0.3)" }}>{error}</div>
          )}
        ...
        <p className="text-center text-sm text-slate-500">
          ...
          <Link href="/register" className="text-emerald-400 hover:text-emerald-300 transition-colors font-medium">Create free account</Link>
        </p>
      </CardContent>
    </Card>
  );
